...
public class ManagerAATest extends BaseTest {
	...
	private void init() throws Exception {
		if(!_init) {
			_token = loginAndGetToken("may", "may");
			_init = true;
		}
	}
	...
	public void create_company_test() throws Exception {
		createCompanyAccess(_token, status().isForbidden(), false);
	}
	...
	public void modify_company_test() throws Exception {
		modifyCompanyAccess(_token, null, true);
	}
	
	@Test
	public void delete_company_test() throws Exception {
		deleteCompanyAccess(_token, null, true);
	}
	
	// for clients
	@Test
	public void create_multiple_clients_test() throws Exception {
		createMultipleClientsAccess(_token, status().isForbidden(), false);
	}
	
	@Test
	public void create_client_test() throws Exception {
		createClientAccess(_token, status().isForbidden(), false);
	}
	...
	public void modify_client_test() throws Exception {
		modifyClientAccess(_token, null, true);
	}
	
	@Test
	public void delete_client_test() throws Exception {
		deleteClientAccess(_token, null, true);
	}
